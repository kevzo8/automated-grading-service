...
export function Timeline() {
  return (
    <div id="timeline-overview" className="space-y-8">
      {/* Header */}
      ...
      {/* Progress Overview */}
      <div id="timeline-progress-overview">
      <Card>
        <CardHeader>
